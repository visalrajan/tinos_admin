...
import 'package:tinos_admin/leavepython_detailspage/leave_python_details_page.dart';

class LeavePython extends StatefulWidget {


  @override
  _LeavePythonState createState() => _LeavePythonState();
}

class _LeavePythonState extends State<LeavePython> {
                                    ...
                                    Container(
                                      child: Padding(
                                        ...
                                        child: GestureDetector(
                                          ...
                                          onTap: () {
                                            Navigator.push(context, MaterialPageRoute(builder: (BuildContext context) => LeavePythonDetailsPage(
                                              emailId: userEmail,
